...
This version processes data while loading it and uses "yield" to speed up things. 
"""
    ...
    for indx1 in range(len_code - 1):
        ...
        for indx2 in range(indx1 + 1, len_code):
            ...
            if c2 == "0":
                ...
                c2 = "0"
            yield first_part + c1 + code[indx1 + 1 : indx2] + c2 + code[indx2 + 1:]
